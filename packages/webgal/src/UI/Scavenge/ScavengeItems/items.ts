...
export interface BaseItem {
  ...
  /** 价格（瓶盖单位，2026-06-09 加）
   *  商人交易的基础价格。后续商人系统接入后会按好感度调整
   *  未设置 = 不可交易（如任务物品）
   */
  price?: number;
}
...
export const CONSUMABLE_ITEMS: ConsumableItem[] = [
  ...
  // epic 食物
  {
    ...
    type: 'consumable',
    rarity: 'epic',
    description: '高热量压缩口粮，能快速恢复饥饿值。',
    stackable: true,
    maxStack: 999,
    price: 50,
    weight: 0.4,
    icon: 'material-symbols:inventory-2-outline',
    effects: [{ type: 'hunger', value: 50 }],
  },
  // legendary 食物
  {
    id: 'food_steak',
    ...
    type: 'consumable',
    rarity: 'legendary',
    description: '极其稀有的新鲜牛排，能同时恢复饥饿和精神。',
    stackable: true,
    maxStack: 999,
    price: 120,
    weight: 0.6,
    ...
    effects: [
      { type: 'hunger', value: 60 },
      { type: 'sanity', value: 15 },
    ],
  },
  // epic 饮水
  {
    id: 'drink_purified_water',
    name: '纯净水',
    type: 'consumable',
    rarity: 'epic',
    description: '经过多重过滤的纯净水，彻底解渴。',
    stackable: true,
    maxStack: 999,
    price: 50,
    weight: 0.4,
    icon: 'material-symbols:water-full-outline',
    effects: [{ type: 'thirst', value: 60 }],
  },
  // legendary 饮水
  {
    ...
    effects: [
      { type: 'thirst', value: 35 },
      { type: 'sanity', value: 20 },
    ],
  },
  // legendary 医疗
  {
    id: 'medicine_adrenaline',
    name: '肾上腺素',
    type: 'consumable',
    rarity: 'legendary',
    description: '急救用肾上腺素，瞬间恢复大量生命值。',
    stackable: true,
    maxStack: 999,
    price: 120,
    weight: 0.05,
...
export const MATERIAL_ITEMS: MaterialItem[] = [
  ...
  // 2026-06-09 加：覆盖稀有度空缺 + 丰富种类
  {
    id: 'material_gunpowder',
    name: '火药',
    type: 'material',
    rarity: 'common',
    description: '可制作弹药或炸药的基础材料。',
    stackable: true,
    maxStack: 999,
    price: 3,
    weight: 0.2,
  ...
  {
    id: 'material_advanced_circuit',
    name: '高级电路',
    type: 'material',
    rarity: 'epic',
    description: '军用级精密电路板，可制作高级电子设备。',
    stackable: true,
    maxStack: 999,
    price: 30,
    weight: 0.3,
    icon: 'material-symbols:developer-board-outline',
  },
  {
    id: 'material_military_alloy',
    name: '军用合金',
    type: 'material',
    rarity: 'legendary',
    description: '罕见的军用级合金，可制作顶级武器和护甲。',
    stackable: true,
    maxStack: 999,
    price: 80,
    weight: 1.5,
  ...
  // 2026-06-09 加：货币（瓶盖，参考辐射4）
  {
    id: 'item_bottlecap',
    name: '瓶盖',
    type: 'material',
    rarity: 'common',
    description: '废土世界的通用货币，由旧时代的瓶盖演变而来。商人收这玩意儿。',
    stackable: true,
    maxStack: 999999,  // 高堆叠上限（货币特性）
    price: 1,           // 自身价格 = 1 瓶盖（不可交易"卖"瓶盖给商人？后续可加）
    weight: 0,          // 不占重量（货币特性）
